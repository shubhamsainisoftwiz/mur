...
import { DashboardMenuManagementRoutingModule } from './dashboard-menu-management-routing.module';
...
@NgModule({
  declarations: [
    DashboardComponent,
    DashboardMenuManagementComponent,

  ],
  imports: [
    CommonModule,
    DashboardMenuManagementRoutingModule,
    NG_Prime,
    FormsModule,
    ReactiveFormsModule,
    ThemeModule,
